...
public class PalestraAPI {

    public void getCategoriasEPalestras(@NonNull Context context, Callback<List<Categoria>, Message> callback, String urlPropertie){
        ...
        },urlPropertie).getCategoriesWithLectures().enqueue(new retrofit2.Callback<List<Categoria>>() {
            @Override
